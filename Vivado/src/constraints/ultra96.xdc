...
set_property PACKAGE_PIN H5   [get_ports {ref_clk_port_0_clk_n}];  # "H5.DSI_CLK_N" Clock capable QBC
set_property IOSTANDARD DIFF_SSTL15 [get_ports {ref_clk_port_0_clk_n}];
set_property PACKAGE_PIN J5   [get_ports {ref_clk_port_0_clk_p}];  # "J5.DSI_CLK_P" Clock capable QBC
set_property IOSTANDARD DIFF_SSTL15 [get_ports {ref_clk_port_0_clk_p}];
