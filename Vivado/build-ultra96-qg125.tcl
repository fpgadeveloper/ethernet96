#
# build.tcl: Tcl script for re-creating project 'ultra96_qg125'
#
#*****************************************************************************************
...
set file "[file normalize "$origin_dir/src/constraints/ultra96-qg125.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/ultra96-qg125.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/ultra96-qg125.xdc"]" $obj
...
# Create block design
source $origin_dir/src/bd/design_1-ultra96-qg125.tcl
