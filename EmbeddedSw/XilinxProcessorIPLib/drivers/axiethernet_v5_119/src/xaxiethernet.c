			   ...
			   u32 RegisterNum, u16 *PhyDataPtr)
{
	...
	xdbg_printf(XDBG_DEBUG_GENERAL,
		...
		InstancePtr->BaseAddressForMdio);

	/*
	 * Wait till MDIO interface is ready to accept a new transaction.
	 */
	TimeoutLoops = Xil_poll_timeout(Xil_In32,InstancePtr->BaseAddressForMdio+
	...
	XAxiEthernet_WriteReg(InstancePtr->BaseAddressForMdio,
	...
	*PhyDataPtr = (u16) XAxiEthernet_ReadReg
			(InstancePtr->BaseAddressForMdio,XAE_MDIO_MRD_OFFSET);
	xdbg_printf(XDBG_DEBUG_GENERAL,
